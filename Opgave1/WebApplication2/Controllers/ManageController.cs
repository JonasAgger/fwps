    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeNameSuccess ? "Dit Dansk Biavler Forening's kontrolnummer er nu opdateret."
                : message == ManageMessageId.RemovePhoneSuccess ? "Your phone number was removed."
                : message == ManageMessageId.ChangeAddressSuccess ? "Din addresse er nu opdateret"
                : "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeDBF(ChangeDBFViewModel model)
        {
